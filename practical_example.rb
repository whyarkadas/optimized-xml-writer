...
if __FILE__ == $0
  ...
  CSV.open('sample_data.csv', 'w') do |csv|
  ...
  PracticalXMLConverter.csv_to_xml('sample_data.csv', 'from_csv.xml')
  XMLValidator.validate_xml_file('from_csv.xml')

  puts "\n" + "="*50 + "\n"

  # Example 2: JSONL to XML
  PracticalXMLConverter.jsonl_to_xml('sample_data.jsonl', 'from_jsonl.xml')
  XMLValidator.validate_xml_file('from_jsonl.xml')

  puts "\n" + "="*50 + "\n"

  # Example 3: Simulate large database export
  PracticalXMLConverter.simulate_database_to_xml('from_database.xml', 5000, 500)
  XMLValidator.validate_xml_file('from_database.xml')
  ...
  PracticalXMLConverter.array_to_xml_chunked(large_array, 'from_array.xml', 200)
  XMLValidator.validate_xml_file('from_array.xml')

  puts "\n=== Summary ===\n"
  puts "Generated files:"
  ['from_csv.xml', 'from_jsonl.xml', 'from_database.xml', 'from_array.xml'].each do |file|
    if File.exist?(file)
